...
HD_PWD='C:/Users/User.1/Desktop/Work/Zybo-Z7-10-HDMI/proj/test_proc/test_proc.runs/design_1_hsv_to_rgb_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_hsv_to_rgb_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_hsv_to_rgb_0_1.tcl
