...
/* Definitions for peripheral AXI_GPIO_DATA */
#define XPAR_AXI_GPIO_DATA_BASEADDR 0x41230000
#define XPAR_AXI_GPIO_DATA_HIGHADDR 0x4123FFFF
#define XPAR_AXI_GPIO_DATA_DEVICE_ID 1
#define XPAR_AXI_GPIO_DATA_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_DATA_IS_DUAL 1
...
/* Canonical definitions for peripheral AXI_GPIO_DATA */
#define XPAR_GPIO_1_BASEADDR 0x41230000
#define XPAR_GPIO_1_HIGHADDR 0x4123FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_DATA_DEVICE_ID
