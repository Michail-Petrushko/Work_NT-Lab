...
HD_PWD='C:/Users/User.1/Desktop/Work/Zybo-Z7-10-HDMI/proj/HSV-RGB/HSV-RGB.runs/design_1_BTNs_test_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_BTNs_test_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_BTNs_test_0_2.tcl
